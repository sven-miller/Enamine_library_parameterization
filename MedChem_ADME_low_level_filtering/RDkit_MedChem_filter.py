...
input_csv_path = 'Rhazinilam_sorted_combo_combo_head200.csv'  # Replace with the path to your CSV file
output_csv_path = 'Rhazinilam_Medchem_Filter.csv'  # Replace with the desired output file path
