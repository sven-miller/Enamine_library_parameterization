...
file_list_path = "/home/millers7/scratch/omega_job_printer/new_list_of_jobs_to_submit/unsubmitted_jobs_2.csv"
...
for i, chunk in enumerate(chunks):
    ...
    job_file_name = f"whole_library_omega_local_write_prefix/omega_job_{i + 1}.sb"
    ...
    for file_path in chunk:
        ...
        command_template = f"/home/millers7/projects/openeye/bin/oeomega fastrocs -in /home/millers7/scratch/Enamine_NP_library_fixpka_output/{file_path} -out /scratch/millers7/job_${{SLURM_JOBID}}/{output_name} -prefix /scratch/millers7/job_${{SLURM_JOBID}}/ -flipper_maxCenters 3 -maxConfs 10 -warts true -commentEnergy -strict false && cp /scratch/millers7/job_${{SLURM_JOBID}}/{output_name} /home/millers7/scratch/Enamine_NP_library_oeomega_fastrocs_output/"
